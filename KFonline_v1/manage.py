...
from kefu import create_app
from exts import db
from apps.cms import models as cms_models
from apps.front import models as front_maodels
...
FrontUser = front_maodels.FrontUser
...
def create_role():
    ...
    operator = CMSRole(name="运营",desc='管理帖子，管理评论，管理前台人员')
